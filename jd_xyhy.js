...
!(async () => {
	...
	console.log(`\n入口：https://lzdz1-isv.isvjcloud.com/dingzhi/tiger/gold/activity/15725835?activityId=dz2201100014002401&shareUuid=e4064ff79767418ca62dbca70b7e71bb\n`);
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                'e4064ff79767418ca62dbca70b7e71bb',
            ]
            $.bean = 0;
